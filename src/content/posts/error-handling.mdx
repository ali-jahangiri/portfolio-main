...
### How to do Centralization on our Error handling ?
...
- Error message and stack trace**Error rate (%)**: errors per 1k requests or per user session.
...
### 10. Avoid performance impact of heavy logging
...
### 11. Graceful degradation at scale
